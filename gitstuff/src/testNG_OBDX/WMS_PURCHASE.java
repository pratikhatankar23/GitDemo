...
public class WMS_PURCHASE {
	...
	// Method 1: WMS Recurring Purchase SIP Operation
	@Test(groups= {"WMS"})
	public void WMSRecurringPurchaseSip() throws InterruptedException, IOException {
		...
		FileUtils.copyFile(src, new File(
				"C://Users//pphatank//Desktop//ScreenshotsUsing_Selenium//Purchase//Recurring_Purchase_SIP_Confirmation.png"));
	...
	// Method 2: WMS Recurring Purchase SI Operation
	@Test(groups= {"WMS"})
	public void WMSRecurringPurchaseSi() throws InterruptedException, IOException {
		...
		w.until(ExpectedConditions.visibilityOfElementLocated(By.id("oj-select-choice-folio-number")));
...
//Set Instructions
		...
		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File(
				"C://Users//pphatank//Desktop//ScreenshotsUsing_Selenium//Purchase//Recurring_Purchase_SI_Confirmation.png"));
	...
	public void WMSOnetimePurchase() throws InterruptedException, IOException {
		...
		FileUtils.copyFile(src,
				new File("C://Users//pphatank//Desktop//ScreenshotsUsing_Selenium//Purchase//Onetime_Purchase_Confirmation.png"));
